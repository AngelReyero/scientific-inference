...
ggsave('Simulation_true/figures/cfi_pfi_SAGEvalueFunc_orig_true.pdf', width=4, height=3)
...
ggsave('Simulation_true/figures/cfi_pfi_SAGEvalueFunc_errorBars_true.pdf', width=4, height=3)
